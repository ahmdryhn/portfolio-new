...
export const STACKS: SkillProps = {
  ...
  "Adobe Illustrator": <SiAdobeillustrator size={iconSize} />,
  "Adobe Lightroom": <SiAdobelightroom size={iconSize} />,
  Git: <SiGit size={iconSize} />,
  Postman: <SiPostman size={iconSize} />,
  Figma: <SiFigma size={iconSize} />,
  Canva: <SiCanva size={iconSize} />,
  "Microsoft Excel": <SiMicrosoftexcel size={iconSize} />,
  "Microsoft PowerPoint": <SiMicrosoftpowerpoint size={iconSize} />,
  "Microsoft Word": <SiMicrosoftword size={iconSize} />,
  "Microsoft Visio": <SiMicrosoftvisio size={iconSize} />,
  Notion: <SiNotion size={iconSize} />,
  "Google Ads": <SiGoogleads size={iconSize} />,
  "Google Colab": <SiGooglecolab size={iconSize} />,
  "Google Analytics": <SiGoogleanalytics size={iconSize} />,
  Instagram: <SiInstagram size={iconSize} />,
  Discord: <SiDiscord size={iconSize} />,
  Native: <SiNativescript size={iconSize} />,
};
